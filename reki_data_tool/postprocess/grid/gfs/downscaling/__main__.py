...
def serial(
    ...
    from reki_data_tool.postprocess.grid.gfs.downscaling.task_serial import make_downscaling_data_serial
...
def dask_v1(
    ...
    from reki_data_tool.postprocess.grid.gfs.wxzx.task_dask_v1 import make_wxzx_data_by_dask_v1
