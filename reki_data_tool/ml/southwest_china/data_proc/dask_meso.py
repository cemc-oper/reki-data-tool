...
def main():
    date_list = pd.date_range(
        "2021-10-01 00:00", "2021-12-31 23:59",
        freq="12h",
    )
    ...
    for date in date_list:
        for hour in forecast_hours:
            ...
            output_file_name = f"meso_cn_{start_time_label}_{forecast_time_label}.grb2"
            output_file_path = Path(OUTPUT_BASE_DIRECTORY, "meso", output_file_name)
